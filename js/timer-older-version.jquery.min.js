...
(function(s) {
    ...
    t.prototype.init = function() {
        ...
        this.hrsNum > 0 && (this.options.showHours=!0), this.options.showHours ? this.$el.html(this.hrsStr + ":" + this.minsStr + ":" + this.secsStr) : this.$el.html(this.minsStr + ":" + this.secsStr)
